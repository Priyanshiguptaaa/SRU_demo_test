...
class Twitter(torch.utils.data.Dataset):
    ...
    def __init__(self, text_field, label_field, path=None, file=None, examples=None, **kwargs):
        ...
        text_field.preprocessing = torchtext.legacy.data.Pipeline(clean_str)
        ...
        if examples is None:
            ...
            with open(path) as f:
                ...
                for line in f.readlines():
                    ...
                    if line[-2] == '0':
                        a += 1
                        examples += [torchtext.legacy.data.Example.fromlist([sentence, 'negative'], fields=fields)]
                    elif line[-2] == '1':
                        a += 1
                        examples += [torchtext.legacy.data.Example.fromlist([sentence, 'negative'], fields=fields)]
                    elif line[-2] == '3':
                        b += 1
                        examples += [torchtext.legacy.data.Example.fromlist([sentence, 'positive'], fields=fields)]
                    elif line[-2] == '4':
                        b += 1
                        examples += [torchtext.legacy.data.Example.fromlist([sentence, 'positive'], fields=fields)]
